...
public class UIRenderHelper {
    ...
    public static void angledGradient(@NotNull PoseStack ms, float angle, int x, int y, int breadth, int length, Couple<Color> c) {
        angledGradient(ms, angle, x, y, 0, breadth, length, c);
    }

    public static void angledGradient(@NotNull PoseStack ms, float angle, int x, int y, int z, int breadth, int length, Couple<Color> c) {
        angledGradient(ms, angle, x, y, z, breadth, length, c.getFirst(), c.getSecond());
    }

    public static void angledGradient(@NotNull PoseStack ms, float angle, int x, int y, int breadth, int length, Color color1, Color color2) {
     ...
     */
    public static void angledGradient(@NotNull PoseStack ms, float angle, int x, int y, int z, int breadth, int length, Color color1, Color color2) {
        ms.pushPose();
        ms.translate(x, y, z);
        ms.mulPose(Vector3f.ZP.rotationDegrees(angle - 90));
