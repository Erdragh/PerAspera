package com.github.erdragh.jet_suit_additions.util.gui;
...
public class Theme {
    ...
    @NotNull
    public static Couple<Color> p(@NotNull Key key) {return p(key.get());}
    @NotNull public static Couple<Color> p(String key) {return resolve(key).asPair();}

    @NotNull public static Color c(@NotNull Key key, boolean first) {return c(key.get(), first);}
    @NotNull public static Color c(String key, boolean first) {return p(key).get(first);}

    public static int i(@NotNull Key key, boolean first) {return i(key.get(), first);}
    public static int i(String key, boolean first) {return p(key).get(first).getRGB();}

    @NotNull public static Color c(@NotNull Key key) {return c(key.get());}
    @NotNull public static Color c(String key) {return resolve(key).get();}

    public static int i(@NotNull Key key) {return i(key.get());}
